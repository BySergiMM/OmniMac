...
| 📋 **Historial del portapapeles** | Guarda **texto, imágenes y archivos**; ⇧⌘V abre el historial, **escribe para buscar**, **⌥P ancla** lo que uses siempre y pega el elemento elegido donde estabas. **No guarda nada de lo que copies en un gestor de contraseñas** ni en las apps que tú le digas. Pausa cuando quieras y, si lo activas, se conserva en disco. | Maccy |
